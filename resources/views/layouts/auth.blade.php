...
<head>
    ...
    <title>@yield('title', config('app.name', 'Butimba'))</title>
    ...
    <meta property="og:title" content="{{ config('app.name', 'Butimba') }}">
    <meta property="og:description" content="Elimu bora kwa walimu wa kisasa">
    <meta property="og:image" content="{{ asset('favicon.png') }}">
    <meta property="og:type" content="website">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="{{ config('app.name', 'Butimba') }}">
    <meta name="twitter:description" content="Elimu bora kwa walimu wa kisasi">
...
<body class="font-['Nunito',sans-serif] antialiased text-slate-800 min-h-screen">
    ...
    <main id="authMain" class="relative z-10 min-h-screen flex items-center justify-center py-0 px-0 sm:py-8 sm:px-6 lg:px-8">
        <div class="w-full max-w-5xl grid lg:grid-cols-2 gap-0 lg:gap-8 items-center">
            ...
            {{-- Left Column: Image + Animated ELMS Text (hidden on mobile) --}}
            <div class="hidden lg:flex flex-col justify-center relative overflow-hidden rounded-3xl h-[600px] shadow-2xl">
                ...
                <div id="authSlideshow" class="absolute inset-0">
                    <img src="{{ asset('medium-shot-student-studying.jpg') }}" alt="" class="auth-slide absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-100">
                    <img src="{{ asset('medium-shot-students-classroom.jpg') }}" alt="" class="auth-slide absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-0">
                    <img src="{{ asset('young-student-sitting-university-library-break-from-studying.jpg') }}" alt="" class="auth-slide absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 opacity-0">
                </div>
                {{-- Slide Indicators --}}
                ...
                <div class="relative z-10 p-12 flex flex-col justify-center h-full">
                    ...
                    <div class="flex items-center gap-3 mb-8 slide-up">
                        <img src="{{ asset('logo.png') }}" alt="Butimba Teachers College" class="w-12 h-12 object-contain">
                        <div>
                            <h1 class="text-2xl font-extrabold text-white tracking-tight">Butimba Teachers College</h1>
                            <p class="text-gold-300 text-sm font-medium">Elimu bora kwa walimu wa kisasi</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6 mt-4">
                        ...
                        <div class="slide-up-delay-2 space-y-4">
                            <div class="flex items-start gap-3 float-text" style="animation-delay: 0s;">
                                ...
                                <div>
                                    <p class="text-white font-semibold text-base">Smart Learning</p>
                                    <p class="text-emerald-100/80 text-sm">Track courses, assignments & grades in real-time</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 float-text" style="animation-delay: 1s;">
                                ...
                                <div>
                                    <p class="text-white font-semibold text-base">Digital Resources</p>
                                    <p class="text-emerald-100/80 text-sm">Access course materials & e-books anytime</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3 float-text" style="animation-delay: 2s;">
                                ...
                                <div>
                                    <p class="text-white font-semibold text-base">Excel in Teaching</p>
                                    <p class="text-emerald-100/80 text-sm">Tools and insights to advance your career</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-auto pt-8 slide-up-delay-3">
                        <div class="flex items-center gap-2 text-emerald-100/60 text-xs">
                            ...
                            <span>Trusted by thousands of educators across Tanzania</span>
                        </div>
                    </div>
                </div>
            </div>
